//
//  BusinessCompleteCell.swift
//  ATB
//
//  Created by YueXi on 9/7/20.
...
class BusinessCompleteCell: UITableViewCell {
    
    static let reuseIdentifier = "BusinessCompleteCell"
    static let rowHeight: CGFloat = 94 //(80 + 14)
